...
with row1_col1:
    ...
    if enable_scheduled_fee:
        if tco_pp_unit > tco_scheduled > 0:
            ...
            # --- MODIFICATION: Annotation positioned above the line ---
            fig_tco_bar.add_annotation(x=0.5, y=tco_pp_unit, text=f"<b>-{saving:.1f}%</b>", showarrow=False, yshift=10, font=dict(color="#186e80", size=14))
        if tco_scheduled > single_flat_fee_tco > 0:
            ...
            # --- MODIFICATION: Annotation positioned above the line ---
            fig_tco_bar.add_annotation(x=1.5, y=tco_scheduled, text=f"<b>-{saving:.1f}%</b>", showarrow=False, yshift=10, font=dict(color="#4fb18c", size=14))
        if tco_pp_unit > single_flat_fee_tco > 0:
            ...
            # --- MODIFICATION: Annotation positioned to the left of the vertical drop, above the line ---
...
with row2_col1:
    ...
    if enable_scheduled_fee:
        if avg_price_pp_unit > avg_price_scheduled > 0:
            ...
            # --- MODIFICATION: Annotation positioned above the line ---
            fig_bar.add_annotation(x=0.5, y=avg_price_pp_unit, text=f"<b>-{saving:.1f}%</b>", showarrow=False, yshift=10, font=dict(color="#186e80", size=14))
        if avg_price_scheduled > avg_price_single_flat > 0:
            ...
            # --- MODIFICATION: Annotation positioned above the line ---
            fig_bar.add_annotation(x=1.5, y=avg_price_scheduled, text=f"<b>-{saving:.1f}%</b>", showarrow=False, yshift=10, font=dict(color="#4fb18c", size=14))
